...
#include "src/head/Estimation.hh"
...
Estimation::Estimation(TString configfile){
	/* 
	constructs the Estimation Class 
...
Estimation::~Estimation(){
	/* 
	destructs the Estimation Class
	parameters: none
	return: none
	*/
...
//____________________________________________________________________________
void Estimation::Initialize(){
	/*
	initializes the Estimation class, defining standard values of certain 
        variables
	parameters: none
	return: none
	*/
...
//____________________________________________________________________________
bool Estimation::KinematicRegionSelection(AKROSD regionselection){
	/*
