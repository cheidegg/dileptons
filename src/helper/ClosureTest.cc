...
#include "src/head/ClosureTest.hh"
...
ClosureTest::ClosureTest(TString configfile){
	/* 
	constructs the ClosureTest Class 
...
ClosureTest::~ClosureTest(){
	/* 
	destructs the ClosureTest Class
	parameters: none
	return: none
	*/
...
//____________________________________________________________________________
void ClosureTest::Initialize(){
	/*
	initializes the ClosureTest class, defining standard values of certain 
        variables
	parameters: none
	return: none
	*/
...
//____________________________________________________________________________
void ClosureTest::CheckInput(){
	/*
	checks if all inputs are available, i.e. ???
	parameters: none
	return: none
	*/
...
//____________________________________________________________________________
bool ClosureTest::KinematicRegionSelection(AKROSD regionselection){
	/*
