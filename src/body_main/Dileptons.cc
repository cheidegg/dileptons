...
//____________________________________________________________________________
void Dileptons::LoadConfigurationFile(TString configfile){
	/*
	...
	*/
	...
	while(IN.getline(buffer, 1000, '\n')){
		...
		if(symbol == 'v') {
			if      (type == "TString" && name == "Mode"      ) cMode          = value;
			else if (type == "TString" && name == "Run"       ) cRun           = value;
		...
		if(symbol == 'm') {
			if      (type == "AKROSD"  && name != ""          ) cMRDefinitions[name]   = value;
		}

		if(symbol == 'b') {
			if      (type == "AKROSD"  && name != ""          ) cBRDefinitions[name]   = value;
		}

		if(symbol == 's') {
			if      (type == "AKROSD"  && name != ""          ) cSRDefinitions[name]   = value;
		}

		if(symbol == 'mf') {
			if      (type == "TString" && name != ""          ) cMRSamples[name]       = value;
		}

		if(symbol == 'bf') {
			if      (type == "TString" && name != ""          ) cBRSamples[name]       = value;
		}

		if(symbol == 'sf') {
			if      (type == "TString" && name != ""          ) cSRSamples[name]       = value;
		}

		if(symbol == 'mx') {
			if      (type == "float"   && name != ""          ) cMRCrossSections[name] = value.Atof();
		}

		if(symbol == 'bx') {
			if      (type == "float"   && name != ""          ) cBRCrossSections[name] = value.Atof();
		}

		if(symbol == 'sx') {
			if      (type == "float"   && name != ""          ) cSRCrossSections[name] = value.Atof();
		}

		if(symbol == 'mt') {
			if      (type == "TString" && name != ""          ) cMRSampleIsData[name]  = SampleIsData(value);
		}

		if(symbol == 'bt') { 
			if      (type == "TString" && name != ""          ) cBRSampleIsData[name]  = SampleIsData(value);
		}

		if(symbol == 'st') {
			if      (type == "TString" && name != ""          ) cSRSampleIsData[name]  = SampleIsData(value);
		}
...
//____________________________________________________________________________
void Dileptons::CheckAKROSDStringForKR(AKROSD string){
	/*
	checks the AKROSD string according to the rules of kinematic region definitions
	parameters: none
	return: none
	*/
...
//____________________________________________________________________________
void Dileptons::CheckAKROSDStringForOS(AKROSD string){
	/*
...
//____________________________________________________________________________
AKROSD Dileptons::InterpretAKROSDRangeStatements(AKROSD string){
	/*
...
//____________________________________________________________________________
AKROSD Dileptons::InterpretAKROSDIfThElStatements(AKROSD string){
	/*
...
//____________________________________________________________________________
AKROSD Dileptons::InterpretAKROSDAbbreviations(AKROSD string){
	/*
...
//____________________________________________________________________________
AKROSD Dileptons::InterpretAKROSDOperators(AKROSD string){
	/*
...
//____________________________________________________________________________
AKROSD Dileptons::InterpretAKROSD(AKROSD string){
	/*
	...
	*/
	...
	newstring = Dileptons_Tools::FindAndReplace(string, " ", "");
	newstring = InterpretAKROSDRangeStatements(newstring);	
	newstring = InterpretAKROSDIfThElStatements(newstring);
	newstring = Dileptons_Tools::FindAndReplace(newstring, ",", " && ");
	newstring = Dileptons_Tools::FindAndReplace(newstring, "|", " || ");
	newstring = InterpretAKROSDAbbreviations(newstring);
	newstring = InterpretAKROSDOperators(newstring);
...
//____________________________________________________________________________
void Dileptons::CopyOutputOnWebspace(){
	/*
